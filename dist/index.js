...
async function startServer() {
    ...
    // preview_screenshot
    server.registerTool("preview_screenshot", {
        title: "Preview Screenshot",
        description: "Takes a screenshot of the running dev server. Returns a base64 PNG image and a screenshot ID for use with preview_diff.",
        inputSchema: {
    ...
    // preview_diff
    server.registerTool("preview_diff", {
        title: "Preview Diff",
        description: "Returns two stored screenshots side by side for visual comparison. Use screenshot IDs from preview_screenshot results.",
        inputSchema: {
    ...
    server.registerTool("preview_status", {
        ...
        description: "Checks if the dev server is reachable and returns the detected URL. Call this before starting visual work to confirm the server is up.",
        inputSchema: {},
    }, async () => {
        try {
